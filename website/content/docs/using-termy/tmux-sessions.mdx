...
For background sessions without installing tmux, use the [built-in multiplexer](/docs/using-termy/multiplexer). It takes precedence when `multiplexer_enabled = true`. Disable it and restart Termy before switching to tmux.
