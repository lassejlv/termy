...
use crate::config_core::color_keys::{ColorEntryError, apply_color_entry};
use crate::config_core::constants::{
...
use crate::config_core::diagnostics::{ConfigDiagnostic, ConfigDiagnosticKind, ConfigParseReport};
use crate::config_core::schema::{RootSettingId, root_setting_from_key, root_setting_spec};
        ...
        for (line_number, line) in contents.lines().enumerate() {
            ...
            match root_key {
                ...
                RootSettingId::AppIcon => {
                    if let Some(parsed) = crate::config_core::types::AppIcon::from_str(value) {
...
pub fn parse_theme_id(value: &str) -> Option<ThemeId> {
    ...
    let normalized = crate::theme_core::normalize_theme_id(value);
    if matches!(
        normalized.as_str(),
