...
command execution stay in `crates/desktop_app/`; this module only knows how a
...
The desktop app consumes this module from `crates/desktop_app/src/settings_view/`.
