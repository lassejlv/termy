...
use termy_core::command_core::{CommandId, KeybindPlatform, default_keybinds_for_platform};
...
fn write_or_check(path: &Path, contents: &str, check_only: bool, label: &str) -> Result<()> {
    if check_only {
        ...
        bail!(
            "{} are out of date; run `cargo run -p termy_cli --bin xtask -- {}`",
            label,
...
fn default_config_template_path() -> Result<PathBuf> {
    Ok(workspace_root()
        ...
        .join("crates/core/src/config_core/default_config.txt"))
}
...
fn render_keybindings_doc() -> String {
    ...
    output.push_str("_This file is generated by `cargo run -p termy_cli --bin xtask -- generate-keybindings-doc`. Do not edit manually._\n\n");
...
fn render_configuration_doc() -> String {
    ...
    output.push_str("_This file is generated by `cargo run -p termy_cli --bin xtask -- generate-config-doc`. Do not edit manually._\n\n");
