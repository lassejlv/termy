...
KDE's title bar, window controls, and resize borders. On X11/XWayland, Termy
also updates the GTK theme-variant hint from the desktop's light/dark preference
for window managers that support it. This follows the desktop preference,
independently of Termy's terminal color theme.
