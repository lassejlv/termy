...
#[cfg(test)]
use termy_core::tmux_control_core::command::split_control_completion_token;
use termy_core::tmux_control_core::command::{
...
use termy_core::tmux_control_core::control::{
...
impl TmuxClient {
    ...
    fn send_control_command_wait_with_timeout(
        ...
        command: &str,
        timeout: Duration,
    ) -> Result<termy_core::tmux_control_core::control::ControlCommandResult> {
...
mod tests {
    ...
    use anyhow::anyhow;
    use std::cell::Cell;
    use termy_core::tmux_control_core::control::coalescer::signal_fatal_exit;
